                            ...
                            <div class="table-wrapper">
                                <table border="1">
									...
									while ($row = mysqli_fetch_assoc($result)) {
										...
										echo "<td><a href=\"delete.php?codigo=" . $row['id'] . "\">deletar</a>";
										echo "<td><a href=\"editar.php?codigo=" . $row['id'] . "\">editar</a></td>";
										echo "</tr>";
									}
									?>
                                </table>
                            </div><br>
                            <a class="form-control btn btn-primary rounded submit px-3" href="inserir.php">Adicionar atividade</a><br>
